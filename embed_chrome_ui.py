...
# Form implementation generated from reading ui file 'd:\ViewChromeForm\embed_chrome.ui'
#
...
class Ui_FormView(object):
    def setupUi(self, FormView):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1096, 558))
    ...
    def retranslateUi(self, FormView):
        ...
        self.label.setText(_translate("FormView", "TextLabel"))
